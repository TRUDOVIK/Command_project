...
public class ServerSpecification {
    ...
    public static Specification<Server> filterByCriteria(Date startDate, Date endDate, String name, Integer status, Integer type, String indicator) {
        return (root, query, cb) -> {
            ...
            if (indicator != null){
                predicates.add(cb.equal(root.get("additionalIndicators"), indicator));
            }
